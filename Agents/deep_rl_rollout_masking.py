...
from edited_jym.agents import BaseDeepRLAgent
from edited_jym.utils.replay_buffers import BaseReplayBuffer


def deep_rl_rollout_masking(
    timesteps: int,
    random_seed: int,
    ...
    def _fori_body(i: int, val: tuple):
        ...
        action, action_key = agent.act(
            action_key, model_params, current_belief_state, epsilon, invalid_action_mask
        )
