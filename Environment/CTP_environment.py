...
class CTP(MultiAgentEnv):
    def __init__(
        ...
        self.agent_graph, self.origin, self.goal = CTP_generator.generate_graph(
            num_nodes, key, grid_size=grid_size, prop_stoch=prop_stoch
        )
