...
do
    ...
    python main_ppo.py --n_node 10 --time_steps 100000 --log_directory logs/ --random_seed_for_training "$seed" --prop_stoch "$stoch" --wandb_mode online --wandb_project_name node10_different_graphs
done
