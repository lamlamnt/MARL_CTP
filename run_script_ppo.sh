        ...
        do
          ...
          do
            ...
            do
              ...
              python main_ppo.py --n_node 10 --grid_size 15 --time_steps 1000000 --log_directory $log_dir --learning_rate $lr --clip_range $cr --ent_coef $ec --num_steps_before_update $nsbu --num_minibatches $nmb --network_activation $na --network_type $nt
            done
          done
        done
      done
